...
var arr=["images/banner/lanmubanner1.jpg","images/banner/lanmubanner2.jpg","images/banner/lanmubanner3.jpg","images/banner/lanmubanner4.jpg","images/banner/lanmubanner5.jpg",];
var index=0;
...
$(".banner .contentO").on("click",function () {
    if (index==0){
        console.log(index);
        window.location.href="../html/furnitureRecommend.html";
    }
    if (index==1){
